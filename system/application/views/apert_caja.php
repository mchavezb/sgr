        ...
        <div id="main-content">
            <div id="contenido">
              ...
              <div class="row-fluid">
                ...
                <table>
                <tr>
                <td colspan="2"><input id="det_" type="radio" name="tipo_apertura" value="detallada">Detallada</td>
                </tr>
                <tr>
                <td colspan="2"><input id="res_" type="radio" name="tipo_apertura" value="resumida" checked="checked">Resumida</td>
                </tr>
                <tr>
