    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <div class="row-fluid">
            <form id="form" action="OP/registrarMesa.php" method="post">
			  <fieldset>
				<legend>Registrar Mesa</legend>
				<label># Mesa</label>
				<input type="text" placeholder="..." name="numero"></br>
				<label>Capacidad</label>
				<input type="text" placeholder="..." name="capacidad"></br>
				</br>
