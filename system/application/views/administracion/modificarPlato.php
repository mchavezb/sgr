      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <div class="row-fluid">
            <form>
			  <fieldset>
				<legend>Modificar Plato</legend>
				<label>Nombre</label>
				<input type="text" value="Lomo Saltado"></br>
				<label>Tiempo estimado de preparación</label>
				<input type="text" value="15 m"></br>
				<label>Precio</label>
				<input type="text" value="20.00"></br>
				</br>
				<a href="" class="btn btn-primary">Guardar</a><a href="mesas.php" class="btn btn-danger">Cancelar</a>
			  </fieldset>
			</form>
          </div><!--/row-->
