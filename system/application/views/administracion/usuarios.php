  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <h1>Usuarios</h1>
		  <a href="registrarUsuario.php" class="btn btn-primary"><i class="icon-plus-sign icon-white"></i> Registrar</a>
		  <hr>
            ...
            <table class="table table-hover">
				...
				<tbody>
					<tr>
						...
						<td>p.perez</td>
						<td>Mozo</td>
						<td><a href="modificarUsuario.php" class="btn btn-info">Modificar</a><a href="" class="btn btn-danger"><i class="icon-trash icon-white"></i></a></td>
					</tr>
				</tbody>
			</table>
          </div><!--/row-->
