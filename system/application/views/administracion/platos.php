  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <h1>Platos</h1>
		  <a href="registrarPlato.php" class="btn btn-primary"><i class="icon-plus-sign icon-white"></i> Registrar</a>
		  <hr>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="modificarPlato.php" class="btn btn-info">Modificar</a><a href="" class="btn btn-danger"><i class="icon-trash icon-white"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
