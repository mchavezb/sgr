<?php //$terminados = @json_decode(file_get_contents("C://xampp/htdocs/sgr/data/data_pedidos_3.json"));
				...
				//mysql_connect("192.168.43.142","root","","sgr");
				$return="";
				...
				while($row = mysqli_fetch_array($rs, MYSQLI_ASSOC)) {				
					$return .= '<div class="platos-m"><form style="display: inline;" method="post" action="http://192.168.43.142/sgr/pedidos/servir">';
